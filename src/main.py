...
#%%
#Prepocessing the data for the MLP
...
if net_type == 'mlp':
    if loss_metric == "correntropy":
        #mlp_univariate_kfold_corr(label, n_steps_in, n_steps_out,n_folds, layers_list, kernel_size)
        #eval_hist = evaluate_history_corr(label, n_folds, n_steps_in, n_steps_out,layers_list, kernel_size)
        mlp_univariate_full_corr(label, n_steps_in, n_steps_out, layers_list,kernel_size)
        mae, rmse, stddev = mlp_univariate_test_corr(label, n_steps_in, n_steps_out, layers_list, kernel_size)
